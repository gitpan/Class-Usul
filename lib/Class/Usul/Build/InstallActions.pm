# @(#)$Id: InstallActions.pm 158 2012-05-20 01:40:37Z pjf $

package Class::Usul::Build::InstallActions;

use strict;
use version; our $VERSION = qv( sprintf '0.1.%d', q$Rev: 158 $ =~ /\d+/gmx );
...
Describes Class::Usul::Build::InstallActions version 0.1.$Revision: 158 $
