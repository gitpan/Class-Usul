# @(#)$Id: Questions.pm 173 2012-06-12 17:40:15Z pjf $

package Class::Usul::Build::Questions;

use strict;
use version; our $VERSION = qv( sprintf '0.1.%d', q$Rev: 173 $ =~ /\d+/gmx );
...
Describes Class::Usul::Build::Questions version 0.1.$Revision: 173 $
